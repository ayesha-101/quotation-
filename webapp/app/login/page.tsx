  ...
  return (
    ...
    >
      <div style={{ width: "100%", maxWidth: 380 }}>
        ...
        <div className="frame-box corner-marks" style={{ display: "flex", justifyContent: "space-between", alignItems: "center", gap: 16, flexWrap: "wrap" }}>
          <div>
            <div
              className="brand-wordmark"
              style={{ fontSize: 11, color: "var(--ink)", marginBottom: 6 }}
            >
              Need an account?
            </div>
